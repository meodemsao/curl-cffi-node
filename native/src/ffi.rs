...
pub const CURLOPT_TLS_EXTENSION_ORDER: CURLoption = 11012; // STRINGPOINT
pub const CURLOPT_TLS_KEY_USAGE_NO_CHECK: CURLoption = 1014;
pub const CURLOPT_TLS_SIGNED_CERT_TIMESTAMPS: CURLoption = 1015;
pub const CURLOPT_TLS_STATUS_REQUEST: CURLoption = 1016;
pub const CURLOPT_TLS_DELEGATED_CREDENTIALS: CURLoption = 11017; // STRINGPOINT
pub const CURLOPT_TLS_RECORD_SIZE_LIMIT: CURLoption = 1018;
pub const CURLOPT_TLS_KEY_SHARES_LIMIT: CURLoption = 1019;
